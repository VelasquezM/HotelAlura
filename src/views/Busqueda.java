...
public class Busqueda extends JFrame {
		...
		btnEliminar.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				...
				if(filaReservas >= 0) {
					...
					int confirmaH = JOptionPane.showConfirmDialog(null, "¿Desea borrar al huésped?");
					...
					if(confirmaH == JOptionPane.YES_OPTION) {
						...
						JOptionPane.showMessageDialog(contentPane, "¡Huésped borrado!");
						limpiarTabla();
						mostrarHuespedes();
						mostrarTablaReservas();
					}
	...
	private void ActualizarReservas() {
		...
		.ifPresent(fila ->{
			...
			//Código para que no cambiemos los id por error
	...
	private void actualizarHuespedes() {
		...
		}, ()-> JOptionPane.showInternalMessageDialog(this, "Por favor, no seas animal xD"));
	}
